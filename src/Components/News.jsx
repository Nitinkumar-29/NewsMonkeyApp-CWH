...
const News = (props) => {
  ...
  const updateNews = async () => {
    ...
    console.log(parsedData.articles[5].title);
    ...
    <>
      {
        ...
        >
          ...
          {!loading && articles && (
            <span
              className="mx-2 flex-end d-flex px-3 py-1 mt-5 text-center text-white"
              style={{
          ...
          {!loading && !articles && (
            <div style={{ marginTop: "10rem" }}>
              API request access has reached its limit
            </div>
          )}
          {loading && (
            <Spinner
          ...
          <div className="container row my-1" style={{}}>
            {!loading &&
              articles &&
